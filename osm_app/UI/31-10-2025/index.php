      ...
      <div class="col-md-6 p-0">
        <div class="d-flex justify-content-between align-items-center flex-wrap px-2 py-2 bg-light">
          ...
          <div class="btn-group" role="group" aria-label="Page Navigation">
            <button class="btn btn-sm lh-1 py-2 d-flex align-items-center btn-outline-secondary" onclick="goToSlide('prev')" id="prevBtn" data-bs-toggle="tooltip" title="Previous Page">
              <i class="bi bi-chevron-double-left me-2"></i> Previous
            </button>
            <button class="btn btn-sm lh-1 py-2 d-flex align-items-center btn-outline-secondary" onclick="goToSlide('next')" id="nextBtn" data-bs-toggle="tooltip" title="Next Page">
          ...
          <div class="d-flex align-items-center gap-2">
            ...
            <select id="pageSelect" class="form-select form-select-sm w-auto" data-bs-toggle="tooltip" title="Select Page" onchange="goToSlide(this.value)">
              <?php for ($i = 1; $i <= count($images); $i++): ?>
                <option value="<?= $i - 1 ?>">Page <?= $i ?></option>
              <?php endfor; ?>
            </select>
          </div>
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <div class="btn-group" role="group" aria-label="Zoom Controls">
              <button class="btn btn-sm btn-outline-dark" id="zoomInBtn" data-bs-toggle="tooltip" title="Hover to Zoom">
            ...
            <div class="btn-group" role="group" aria-label="Zoom Controls">
              ...
              <button class="btn btn-sm btn-outline-secondary" id="rotate-image" data-bs-toggle="tooltip" title="Rotate Image Orientation">
