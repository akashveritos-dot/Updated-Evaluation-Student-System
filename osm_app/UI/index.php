...
<body class="bg-danger">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-6 p-0">
        <div class="d-flex justify-content-between align-items-center flex-wrap px-1 py-1 bg-light">

          <!-- Navigation Buttons -->
          <div class="btn-group" role="group" aria-label="Page Navigation">
            <button class="btn btn-xs lh-1 py-1 d-flex align-items-center btn-outline-secondary" onclick="goToSlide('prev')" id="prevBtn" data-bs-toggle="tooltip" title="Previous Page">
              <i class="bi bi-chevron-double-left me-1"></i> <span class="d-none d-sm-inline">Prev</span>
            </button>
            <button class="btn btn-xs lh-1 py-1 d-flex align-items-center btn-outline-secondary" onclick="goToSlide('next')" id="nextBtn" data-bs-toggle="tooltip" title="Next Page">
              <span class="d-none d-sm-inline">Next</span> <i class="bi bi-chevron-double-right ms-1"></i>
            </button>
            <button class="tutorial-nav-button sheets-btn btn btn-xs lh-1 py-1 d-flex align-items-center btn-outline-primary" id="sheetsToggleBtn" title="Manage Sheets">
              <img src="/media/Tool%20Icon/sheet.png" alt="" style="width: 14px; height: 14px;">
              <span class="ms-1 d-none d-sm-inline">Sheets</span>
            </button>
          </div>

          <!-- Page Selection -->
          <div class="d-flex align-items-center gap-1">
            <label for="pageSelect" class="mb-0 small fw-semibold d-none d-md-inline">Page:</label>
            <select id="pageSelect" class="form-select form-select-xs w-auto" data-bs-toggle="tooltip" title="Select Page" onchange="goToSlide(this.value)">
          ...
          <div class="d-flex align-items-center gap-2">
            <div class="text-muted small fw-semibold d-none d-lg-inline" data-bs-toggle="tooltip" title="Time spent on evaluation">
              <i class="bi bi-clock-history me-1"></i><span id="timeTaken">00:00</span>
            </div>

            <!-- Zoom Controls -->
            <div class="btn-group" role="group" aria-label="Zoom Controls">
              <button class="btn btn-xs btn-outline-dark" id="zoomInBtn" data-bs-toggle="tooltip" title="Hover to Zoom">
            ...
            <div class="btn-group" role="group" aria-label="Zoom Controls">
              ...
              <button class="btn btn-xs btn-outline-secondary" id="rotate-image" data-bs-toggle="tooltip" title="Rotate Image Orientation">
          ...
          <div class="carousel-inner">
            ...
            ?>
              <div class="carousel-item <?= $key == 0 ?  'active' : '' ?>">
                <canvas></canvas>
                <img draggable="false" class="magnifiable-image" src="images/<?= $image ?>" class="d-block w-100" alt="Slide <?= $key ?>">
              </div>
            <?php
            }
            ?>
      ...
      <div class="col-md-6 d-flex flex-column p-0 right-section">
        ...
        <div class="d-flex flex-grow-1">
          <div class="fixed-col d-flex flex-column align-items-center justify-content-start border-end p-2 gap-2 bg-light" style="width: 100px;">
            ...
            $tools = [
              ['name' => 'seen', 'icon' => 'bi-eye', 'label' => 'Seen', 'tooltip' => 'Mark as seen'],
              ['name' => 'mark_blank', 'icon' => 'bi-x', 'label' => 'Mark Blank', 'tooltip' => 'Mark this area as blank'],
              ['name' => 'undo_tool', 'icon' => 'bi-arrow-counterclockwise', 'label' => 'Undo Tool', 'tooltip' => 'Undo last action',],
            ];
            printf("<div style='display:none;' id='tools'>%s</div>", json_encode([
            ...
            foreach ($tools as $i => $tool): ?>
              <div class="gap-2 w-100">
                ...
                <button data-name="<?= @$tool['name'] ?>" class="btn-tool btn btn-sm btn-outline-dark w-100 text-nowrap" <?= @$tool['disabled'] ? 'disabled' : '' ?> data-bs-toggle="tooltip" title="<?= $tool['tooltip'] ?>">
                ...
                <tbody>
                  <?php foreach ($questions as $index => $q): ?>
                    ...
                    <tr class="<?= $index === 0 ? 'active' : '' ?>">
                      ...
                      <td>
                        <button class="btn btn-xs btn-outline-success w-100 select-question"></button>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
                  ...
                  <div class="row align-items-center g-2">
                    ...
                    <div class="col-lg-8 col-md-12">
                      <div class="form-check">
                        <input required class="form-check-input" name="confirm" type="checkbox" id="confirmCheckbox">
      ...
      <div class="modal-content">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title" id="sheetsModalLabel">
            <i class="bi bi-file-earmark-text me-2"></i>Sheet Management
          </h5>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0">All Sheets (<span id="totalSheetsCount">0</span>)</h6>
            <div class="btn-group btn-group-sm">
              <button type="button" class="btn btn-outline-secondary" id="refreshSheetsBtn">
                <i class="bi bi-arrow-clockwise"></i> Refresh
              </button>
              <button type="button" class="btn btn-outline-danger" id="clearAllSheetsBtn">
                <i class="bi bi-trash"></i> Clear All
              </button>
            </div>
          </div>
          <div id="sheetsGrid" class="sheets-grid">
  ...
  <script>
    ...
    // Only initialize carousel if it exists and has items
